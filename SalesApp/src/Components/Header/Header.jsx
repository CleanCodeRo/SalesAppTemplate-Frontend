...
const Header = () => {
  ...
  useEffect(() => {
    setTotalCartPrice(products.reduce((acc, product) => acc + product.price, 0).toFixed(2))
  }, [products])
  ...
  return (
    <div>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white ">
        <p className="flex h-10 items-center justify-center bg-primary-100 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
                  ...
                  <div className="group -m-2 flex items-center p-2 relative cursor-pointer">
                    ...
                    <div
                      className={`absolute mt-14 w-64 right-0 transition-all duration-300 ${
                        showCartProducts
                          ? "opacity-100 translate-y-0 cursor-pointer visible"
                          : "opacity-0 translate-y-2 invisible"
                      }`}
                    >
                      <div className="flex flex-row truncate p-2 px-4 rounded">
                        ...
                        <div id="listElement" className="shadow-xl">
                          ...
                          <div className="p-2 flex bg-white hover:bg-gray-100 border-b border-gray-100">
                            ...
                            <div className="flex flex-col w-18 font-medium items-end">
                              <div className="w-4 h-4 mb-6 hover:bg-red-200 rounded-full text-red-700">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="100%"
                                  height="100%"
                          ...
                          <div className="p-4 justify-center flex bg-white">
                            <Link to="/checkout">
                            <button
                              className="text-base undefined hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold 
